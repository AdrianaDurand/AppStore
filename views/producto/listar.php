...
<body>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header bg-info text-light">
          <h5 class="modal-title" id="modal-title">Nombre del Producto <strong id="${categoria}" style="font-size: 20px;"> </h5>
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      // Asignamos clases a los botones y se le asigna una accion 
      // pra que la realicen en conjunto
      //Detectando click sobre un elemento asincrono
      ...
      tabla.addEventListener("click", (event) => {
        ...
        if(event.target.classList.contains("eliminar")){
          ...
          if(confirm("¿Estás seguo de eliminar?")){
            fetch(`../../controllers/producto.controller.php`, {
              method: "POST",
              body: parametros
            })
